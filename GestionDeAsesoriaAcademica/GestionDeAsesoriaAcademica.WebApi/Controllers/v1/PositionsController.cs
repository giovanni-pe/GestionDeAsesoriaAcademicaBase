...
using GestionDeAsesoriaAcademica.Application.Features.Positions.Commands.DeletePositionById;
using GestionDeAsesoriaAcademica.Application.Features.Positions.Commands.UpdatePosition;
using GestionDeAsesoriaAcademica.Application.Features.Positions.Queries.GetPositionById;
using GestionDeAsesoriaAcademica.Application.Features.Positions.Queries.GetPositions;
using GestionDeAsesoriaAcademica.WebApi.Extensions;
...
namespace GestionDeAsesoriaAcademica.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
